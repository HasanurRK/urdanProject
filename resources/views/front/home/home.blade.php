                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="slider-content-1 slider-animated-1">
                                        ...
                                        <div class="slider-btn btn-hover">
                                            <a href="{{route("product-details",["id"=>5])}}" class="btn animated">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="200">
                        <a href="{{route("product-details",["id"=>5])}}"><img src="{{asset("/")}}assets/images/banner/banner-1.png" alt=""></a>
                        <div class="banner-content-1">
                            <h5>new arrival</h5>
                            <h3>Office Chair</h3>
                            <div class="banner-btn">
                                <a href="{{route("product-details",["id"=>5])}}">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="400">
                        <a href="{{route("product-details",["id"=>5])}}"><img src="{{asset("/")}}assets/images/banner/banner-2.png" alt=""></a>
                        <div class="banner-content-1">
                            <h5>new arrival</h5>
                            <h3>Hanging Chair</h3>
                            <div class="banner-btn">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="600">
                        <a href="{{route("product-details",["id"=>5])}}"><img src="{{asset("/")}}assets/images/banner/banner-3.png" alt=""></a>
                        <div class="banner-content-1">
                            <h5>new arrival</h5>
                            <h3>Folding Chair</h3>
                            <div class="banner-btn">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-7">
                    <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="200">
                        <a href="{{route("product-details",["id"=>5])}}"><img src="{{asset("/")}}assets/images/banner/banner-4.png" alt=""></a>
                        <div class="banner-content-2">
                            <span>Sale 30%</span>
                            <h2>New Furniture</h2>
                            <p>Lorem ipsum dolor sit amet consecte adipisicing elit sed do</p>
                            <div class="btn-style-2 btn-hover">
                                <a href="{{route("product-details",["id"=>5])}}" class="btn">
                                    Shop Now
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-5 col-md-5">
                    <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="400">
                        <a href="{{route("product-details",["id"=>5])}}"><img src="{{asset("/")}}assets/images/banner/banner-5.png" alt=""></a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="home-single-product-img" data-aos="fade-up" data-aos-delay="200">
                        <a href="{{route("product-details",["id"=>$product])}}"><img src="{{asset($product->image)}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="home-single-product-content">
                        <h2 data-aos="fade-up" data-aos-delay="200">{{ $product->name }}</h2>
                        <h3 data-aos="fade-up" data-aos-delay="400">BDT {{$product->selling_price}}</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-wrap mb-35" data-aos="fade-up" data-aos-delay="200">
                                <div class="product-img img-zoom mb-25">
                                    <a href="{{route("product-details",["id"=>$product])}}">
...
{{--                                    </div>--}}
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="product-price">
                                        <span class="old-price">BTD {{$product->regular_price}} </span>
                                        <span class="new-price">BTD {{$product->selling_price}} </span>
                                    </div>
                                </div>
                            </div>
                        </div>

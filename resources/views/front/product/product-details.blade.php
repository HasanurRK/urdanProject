                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="{{asset($subImage->image)}}" style="height: 150px" alt="Product Thumnail">
                                        </div>
                                    </div>
                                    @endforeach
{{--                                    <div class="swiper-slide">--}}
            ...
            <div class="tab-content">
                <div id="des-details1" class="tab-pane active">
                    <div class="product-description-content text-center">
                        ...
                        <p data-aos="fade-up" data-aos-delay="400">Exceper unde omnis iste natusloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo</p>
                    </div>
                </div>
                <div id="des-details2" class="tab-pane">
                    <div class="specification-wrap table-responsive">
                        <p data-aos="fade-up" data-aos-delay="200">{!! $product->long_description !!}}</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi atque blanditiis cum exercitationem hic impedit necessitatibus quos rerum voluptas. Ad amet dicta, eaque exercitationem inventore ipsa ipsum pariatur quidem voluptate.</p>
{{--                        <table>--}}
{{--                            <tbody>--}}
{{--                            <tr>--}}
                        ...
                        <div class="product-wrap" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-img img-zoom mb-25">
                                <a href="{{route("product-details", ["id"=>$relatedProduct->id])}}">
                                    <img src="{{asset($relatedProduct->image)}}" style="height: 250px" alt="">
                                </a>
...
{{--                                </div>--}}
                            ...
                            <div class="product-content">
                                ...
                                <div class="product-price">
                                    <span class="old-price">BTD {{$relatedProduct->regular_price}} </span>
                                    <span class="new-price">BTD {{$relatedProduct->selling_price}} </span>
                                </div>
                            </div>
                        </div>
                    </div>

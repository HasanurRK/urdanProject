                        ...
                        <div class="card-body">
                            <form action="{{ route("update-category") }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="form-control" name="description" id="" cols="20" rows="15">{{ $category->description }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="submit" value="Update Category" class="btn btn-outline-success form-control">
                                    </div>
                                </div>
